...
int main(void)
{
    ...
    window = glfwCreateWindow(game.settings.screenWidth, game.settings.screenHeight, game.settings.title.c_str(), NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return -1;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        drawTexture("..\\Resources\\Sprites\\awesomeface.png");
